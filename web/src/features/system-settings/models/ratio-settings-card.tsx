...
const createModelSchema = (t: Translate) =>
  z.object({
    ...
    ActualModelRatio: createJsonStringField(t),
...
const createGroupSchema = (t: Translate) =>
  z.object({
    ...
    SubscriptionDisabledGroups: createJsonStringField(t, {
      predicate: (parsed) =>
...
export function RatioSettingsCard({
  ...
  const modelNormalizedDefaults = useRef({
    ...
    ActualModelRatio: normalizeJsonString(modelDefaults.ActualModelRatio),
  ...
  const groupNormalizedDefaults = useRef({
    ...
    SubscriptionDisabledGroups: normalizeJsonString(
      groupDefaults.SubscriptionDisabledGroups
    ),
  ...
  const modelForm = useForm<ModelFormValues>({
    ...
    defaultValues: {
      ...
      ActualModelRatio: formatJsonForTextarea(modelDefaults.ActualModelRatio),
  ...
  const groupForm = useForm<GroupFormValues>({
    ...
    defaultValues: {
      ...
      SubscriptionDisabledGroups: formatJsonForTextarea(
        groupDefaults.SubscriptionDisabledGroups
      ),
  ...
  const saveModelRatios = useCallback(
    async (values: ModelFormValues) => {
      const normalized = {
        ...
        ActualModelRatio: normalizeJsonString(values.ActualModelRatio),
  ...
  const saveGroupRatios = useCallback(
    async (values: GroupFormValues) => {
      const normalized = {
        ...
        SubscriptionDisabledGroups: normalizeJsonString(
          values.SubscriptionDisabledGroups
        ),
