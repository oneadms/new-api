                ...
                <div className='flex min-w-0 flex-col gap-3'>
                  <div className='grid grid-cols-1 gap-2 sm:grid-cols-2'>
                    <DetailRow
                      ...
                      value={formatByteSize(sseTrace.metadata.original_size)}
                      mono
                    />
                    <DetailRow
                      label={t('Captured size')}
                      value={formatByteSize(sseTrace.metadata.captured_size)}
                      mono
                    />
                    <DetailRow
                      label={t('Compressed size')}
                      value={formatByteSize(sseTrace.metadata.compressed_size)}
                      mono
                    />
                    <DetailRow
