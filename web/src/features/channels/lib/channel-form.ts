...
export const channelFormSchema = z
  .object({
    ...
    hide_upstream_error: z.boolean().optional(),
  ...
  if (channel.setting) {
    try {
      ...
      extraSettings = {
        ...
        hide_upstream_error: parsed.hide_upstream_error || false,
...
function buildSettingJSON(formData: ChannelFormValues): string {
  const settingObj = {
    ...
    hide_upstream_error: formData.hide_upstream_error || false,
