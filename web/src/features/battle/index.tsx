...
export function Battle() {
  ...
  const connect = useCallback(() => {
    ...
    const ws = new WebSocket(
      ...
      ['new-api-battle', `new-api-bearer.${accessToken}`]
    )
  ...
  let movementLabel = t('Falling')
  if (me?.on_ground) {
    movementLabel = t('Grounded')
  } else if (me && me.vy < 0) {
    movementLabel = t('Jumping')
  }
        ...
        <aside className='flex min-h-0 flex-col gap-4 lg:overflow-y-auto lg:pr-1'>
          <section className='shrink-0 rounded-md border p-4'>
            ...
            <div className='mt-3 grid grid-cols-2 gap-3 text-sm'>
              ...
              <Stat label={t('Movement')} value={movementLabel} />
            </div>
          </section>
