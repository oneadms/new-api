...
func GetStatus(c *gin.Context) {
	...
	data := gin.H{
		...
		"music_player_enabled":        common.MusicPlayerEnabled,
		"music_player_playlist":       common.MusicPlayerPlaylist,
		"music_player_autoplay":       common.MusicPlayerAutoplay,
		"music_player_show_lyrics":    common.MusicPlayerShowLyrics,
