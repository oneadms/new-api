...
func migrateDB() error {
	...
	err := DB.AutoMigrate(
		...
		&CasbinRule{},
		&AuthzRole{},
		&Codex2APIPolicyStrike{},
		&Codex2APIPolicyIPBlock{},
	)
	if err != nil {
		return err
	}
...
func migrateDBFast() error {
	...
	migrations := []struct {
		...
		{&UserGroupPass{}, "UserGroupPass"},
		{&RechargeRewardEvent{}, "RechargeRewardEvent"},
		{&RechargeLotteryDraw{}, "RechargeLotteryDraw"},
		...
		{&Codex2APIPolicyStrike{}, "Codex2APIPolicyStrike"},
		{&Codex2APIPolicyIPBlock{}, "Codex2APIPolicyIPBlock"},
	}
...
` + "`subscription_disabled_groups`" + ` text,
...
PRIMARY KEY (` + "`id`" + `)
	...
	required := []sqliteColumnDef{
		...
		{Name: "restricted_groups", DDL: "`restricted_groups` text"},
		{Name: "subscription_disabled_groups", DDL: "`subscription_disabled_groups` text"},
