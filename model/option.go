...
func InitOptionMap() {
	...
	common.OptionMap["ActualModelRatio"] = ratio_setting.ActualModelRatio2JSONString()
	...
	common.OptionMap["SubscriptionDisabledGroups"] = setting.SubscriptionDisabledGroups2JSONString()
...
func updateOptionMap(key string, value string) (err error) {
	...
	case "ActualModelRatio":
		err = ratio_setting.UpdateActualModelRatioByJSONString(value)
	case "GroupRatio":
	...
	case "SubscriptionDisabledGroups":
		err = setting.UpdateSubscriptionDisabledGroupsByJSONString(value)
